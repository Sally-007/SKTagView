...
//real line /dotted line
@property (assign, nonatomic) BOOL isDottedLine;        //default:NO ---real line
@property (assign, nonatomic) CGFloat cornerRadius;
@property (strong, nonatomic, nullable) UIColor *borderColor;
@property (assign, nonatomic) CGFloat borderWidth;
@property (assign, nonatomic) CGFloat lineDashEqual;    //for dotted line. unit width. default:8.f
